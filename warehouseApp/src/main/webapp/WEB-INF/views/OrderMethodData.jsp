...
<%@include file="Menu.jsp" %>
   ...
   <br>
		...
		<div2 id="div1"><h2>welcome to OrderMethod Data page</h2></div2>
...
<!-- 	<thead class=" bg-dark "> -->
		...
		<td><b><c:out value="${ob.orderId}"/></b></td>
		...
		<td><a href="viewone?id=${ob.orderId}"><img src="../resources/images/view.png" width="40" height="40"/></a></td>
		<td><a href="edit?id=${ob.orderId}"><img src="../resources/images/edit.png" width="40" height="40"/></a></td>
		<td><a href="excel?id=${ob.orderId}"><img src="../resources/images/excel.png" width="40" height="40"/></a></td>
		<td><a href="pdf?id=${ob.orderId}"><img src="../resources/images/pdf.png" width="40" height="40"/></a></td>
