...
public class ShipmentType {
	...
	public ShipmentType(Integer shipmentId, String shipmentMode, String shipmentCode, String shipmentGrade,
			String enableShipment, String note) {
		super();
		this.shipmentId = shipmentId;
	...
	public String toString() {
		return "ShipmentType [shipmentId=" + shipmentId + ", shipmentMode=" + shipmentMode + ", shipmentCode="
				+ shipmentCode + ", shipmentGrade=" + shipmentGrade + ", enableShipment=" + enableShipment + ", note="
				+ note + "]";
	}
